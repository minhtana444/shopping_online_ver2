...
<!--[if (gt IE 9)|!(IE)]><!--><html lang="en"><!--<![endif]-->
    ...
    <link rel="icon" type="image/ico" href="/common_pc/img/fav.ico">

    {$View->start('css')}
    {literal}
        <!--stylesheet include-->

        <link rel="stylesheet" type="text/css" media="all" href="/common_pc/css/colorpicker.css">

        <link rel="stylesheet" type="text/css" media="all" href="/common_pc/css/bootstrap.min.css">

        <link rel="stylesheet" type="text/css" media="all" href="/common_pc/css/settings.css">

        <link rel="stylesheet" type="text/css" media="all" href="/common_pc/css/owl.carousel.css">

        <link rel="stylesheet" type="text/css" media="all" href="/common_pc/css/owl.transitions.css">

        <link rel="stylesheet" type="text/css" media="all" href="/common_pc/css/jquery.custom-scrollbar.css">

        <link rel="stylesheet" type="text/css" media="all" href="/common_pc/css/style.css">

        <link href="/common_pc/css/font-awesome.min.css" rel="stylesheet">
    ...
    <script src="/common_pc/js/jquery-2.1.0.min.js"></script>

    <script src="/common_pc/js/retina.js"></script>

    <script src="/common_pc/js/jquery.themepunch.plugins.min.js"></script>

    <script src="/common_pc/js/jquery.themepunch.revolution.min.js"></script>

    <script src="/common_pc/js/styleswitcher.js"></script>

    <script src="/common_pc/js/colorpicker.js"></script>

    <script src="/common_pc/js/waypoints.min.js"></script>

    <script src="/common_pc/js/owl.carousel.min.js"></script>

    <script src="/common_pc/js/jquery.tweet.min.js"></script>

    <script src="/common_pc/js/jquery.custom-scrollbar.js"></script>

    <script src="/common_pc/js/scripts.js"></script>
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-5 t_xs_align_c">
                                ...
                                <ul class="d_inline_b horizontal_list clearfix f_size_small users_nav">
                                    ...
                                    <li><a href="orders_list.html" class="default_t_color">Giỏ hàng</a></li>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-2 t_align_c t_xs_align_c">
                                ...
                                <p class="f_size_small">Số điện thoại liên hệ: <b class="color_dark">0123456789</b></p>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-5 t_align_r t_xs_align_c">
                                ...
                                <ul class="horizontal_list clearfix d_inline_b t_align_l f_size_small site_settings type_2">
                                    ...
                                    <li class="container3d relative">
                                        ...
                                        <a role="button" href="#" class="color_dark" id="lang_button"><img class="d_inline_middle m_right_10" src="/common_pc/img/flag_vi.png" alt="">Việt Nam</a>

                                        <ul class="dropdown_list type_2 top_arrow color_light">

                                            <li><a href="#" class="tr_delay_hover color_light"><img class="d_inline_middle" src="/common_pc/img/flag_en.jpg" alt="">English</a></li>

                                            <li><a href="#" class="tr_delay_hover color_light"><img class="d_inline_middle" src="/common_pc/img/flag_fr.jpg" alt="">French</a></li>

                                            <li><a href="#" class="tr_delay_hover color_light"><img class="d_inline_middle" src="/common_pc/img/flag_g.jpg" alt="">German</a></li>

                                            <li><a href="#" class="tr_delay_hover color_light"><img class="d_inline_middle" src="/common_pc/img/flag_i.jpg" alt="">Italian</a></li>

                                            <li><a href="#" class="tr_delay_hover color_light"><img class="d_inline_middle" src="/common_pc/img/flag_s.jpg" alt="">Spanish</a></li>
                                    ...
                                    <li class="m_left_20 relative container3d">
                                        ...
                                        <a role="button" href="#" class="color_dark" id="currency_button"><span class="scheme_color"></span> VNĐ</a>
                            ...
                            <div class="clearfix row">
                                ...
                                <div class="col-lg-2 t_md_align_c m_md_bottom_15">
                                    ...
                                    <a href="index-2.html" class="logo d_md_inline_b">
                                        ...
                                        <img src="/common_pc/img/logo.png" alt="">
                                    ...
                                    <div class="clearfix t_sm_align_l f_left f_sm_none relative s_form_wrap m_sm_bottom_15 p_xs_hr_0 m_xs_bottom_5">
                                        ...
                                        <nav role="navigation" class="f_left f_xs_none d_xs_none m_right_35 m_md_right_30 m_sm_right_0">	
                                            ...
                                            <ul class="horizontal_list main_menu type_2 clearfix">
                                                ...
                                                <li class="current relative f_xs_none m_xs_bottom_5 m_left_10 m_xs_left_0"><a href="index-2.html" class="tr_delay_hover color_dark tt_uppercase r_corners"><b>Trang chủ</b></a>

                                                    <!--sub menu-->

                                                    <div class="sub_menu_wrap sub_menu_wrap_new top_arrow d_xs_none type_2 tr_all_hover clearfix r_corners">
                                                ...
                                                <li class="relative f_xs_none m_xs_bottom_5 m_left_10 m_xs_left_0"><a href="category_grid.html" class="tr_delay_hover color_dark tt_uppercase r_corners"><b>Sản phẩm</b></a>

                                                    <!--sub menu-->

                                                    <div class="sub_menu_wrap sub_menu_wrap_new top_arrow d_xs_none tr_all_hover clearfix r_corners w_xs_auto">
                                                        ...
                                                        <img src="/common_pc/img/woman_image_1.jpg" class="d_sm_none f_right m_bottom_10" alt="">
                                                ...
                                                <li class="relative f_xs_none m_xs_bottom_5 m_left_10 m_xs_left_0"><a href="blog.html" class="tr_delay_hover color_dark tt_uppercase r_corners"><b>Khuyến mãi</b></a>

                                                    <!--sub menu-->

                                                    <div class="sub_menu_wrap sub_menu_wrap_new top_arrow d_xs_none type_2 tr_all_hover clearfix r_corners type_2_new">
                                                ...
                                                <li><a class="color_dark tr_delay_hover" href="rtl/index.html">RTL version</a></li>
                                                ...
                                                <li class="relative f_xs_none m_xs_bottom_5 m_left_10 m_xs_left_0"><a href="contact.html" class="tr_delay_hover color_dark tt_uppercase r_corners"><b>Liên hệ</b></a></li>
                                                ...
                                                <ul class="products_list">
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="clearfix">
                                                            ...
                                                            <img class="f_left m_right_10" src="/common_pc/img/shopping_c_img_1.jpg" alt="">
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="clearfix">
                                                            ...
                                                            <img class="f_left m_right_10" src="/common_pc/img/shopping_c_img_2.jpg" alt="">
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="clearfix">
                                                            ...
                                                            <img class="f_left m_right_10" src="/common_pc/img/shopping_c_img_3.jpg" alt="">
            ...
            <section class="revolution_slider">
                ...
                <div class="r_slider">
                    ...
                    <ul>
                        ...
                        <li class="f_left" data-transition="curtain-1" data-slotamount="7" data-custom-thumb="/common_pc/img/slide_02.jpg">

                            <img src="/common_pc/img/fw_slide_03.jpg" alt="" data-bgrepeat="no-repeat" data-bgfit="cover" data-bgposition="center center">
                            ...
                            <div class="caption sft stb color_light" data-x="742" data-y="335" data-speed="900" data-start="2600">
                                ...
                                <a href="http://themeforest.net/item/flatastic-ecommerce-html-template/7221813?ref=mad_velikorodnov" role="button" class="button_type_4 bg_scheme_color color_light r_corners tt_uppercase">Buy Now</a>

                            </div>

                        </li>

                        <li class="f_left" data-transition="cube" data-slotamount="7" data-custom-thumb="/common_pc/img/slide_01.jpg">

                            <img src="/common_pc/img/fw_slide_02.jpg" alt="" data-bgrepeat="no-repeat" data-bgfit="cover" data-bgposition="center center">
                            ...
                            <div class="caption lfb ltt color_light" data-x="206" data-y="318" data-speed="500" data-start="1700">
                                ...
                                <a href="http://themeforest.net/item/flatastic-ecommerce-html-template/7221813?ref=mad_velikorodnov" role="button" class="button_type_4 bg_scheme_color color_light r_corners tt_uppercase">View Collection</a>

                            </div>

                        </li>

                        <li class="f_left" data-transition="cube" data-slotamount="7" data-custom-thumb="/common_pc/img/slide_03.jpg">

                            <img src="/common_pc/img/fw_slide_01.jpg" alt="" data-bgrepeat="no-repeat" data-bgfit="cover" data-bgposition="center center">

                            <div class="caption lft ltt" data-x="center" data-y="58" data-speed="1500" data-start="1200" data-easing="easeOutBounce">

                                <img src="/common_pc/img/slider_layer_img.png" alt="">
                            ...
                            <div class="caption sfb stb color_light" data-x="center" data-y="352" data-speed="1000" data-start="2900">
                                ...
                                <a href="http://themeforest.net/item/flatastic-ecommerce-html-template/7221813?ref=mad_velikorodnov" role="button" class="button_type_4 bg_scheme_color color_light r_corners tt_uppercase">Shop Now</a>
                ...
                <div class="container">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 m_bottom_50 m_xs_bottom_0">
                            ...
                            <a href="#" class="d_block animate_ftb h_md_auto m_xs_bottom_15 banner_type_2 r_corners red t_align_c tt_uppercase vc_child n_sm_vc_child">
                                ...
                                <span class="d_inline_middle">
                                    ...
                                    <img class="d_inline_middle m_md_bottom_5" src="/common_pc/img/banner_img_3.png" alt="">

                                    <span class="d_inline_middle m_left_10 t_align_l d_md_block t_md_align_c">

                                        <b>100% Hài lòng</b><br><div style="height:5px"></div><span class="color_dark p_t_10">với sản phẩm</span>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            ...
                            <a href="#" class="d_block animate_ftb h_md_auto m_xs_bottom_15 banner_type_2 r_corners green t_align_c tt_uppercase vc_child n_sm_vc_child">
                                ...
                                <span class="d_inline_middle">
                                    ...
                                    <img class="d_inline_middle m_md_bottom_5" src="/common_pc/img/banner_img_4.png" alt="">

                                    <span class="d_inline_middle m_left_10 t_align_l d_md_block t_md_align_c">

                                        <b>Các khu vực</b><br><div style="height:5px"></div><span class="color_dark">giao hàng miễn phí</span>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            ...
                            <a href="#" class="d_block animate_ftb h_md_auto banner_type_2 r_corners orange t_align_c tt_uppercase vc_child n_sm_vc_child">
                                ...
                                <span class="d_inline_middle">
                                    ...
                                    <img class="d_inline_middle m_md_bottom_5" src="/common_pc/img/banner_img_5.png" alt="">

                                    <span class="d_inline_middle m_left_10 t_align_l d_md_block t_md_align_c">

                                        <b>Khuyến mãi lớn</b><br><div style="height:5px"></div><span class="color_dark">Chọn nhanh nào!</span>
                    ...
                    <div class="clearfix">
                        ...
                        <ul class="horizontal_list clearfix tt_uppercase isotope_menu f_size_ex_large f_left f_xs_none m_xs_bottom_15" data-carousel-filter=".wfilter_carousel">
                            ...
                            <li class="active m_right_5 m_bottom_10 m_xs_bottom_5 animate_ftr"><button class="button_type_2 bg_light_color_1 r_corners tr_delay_hover tt_uppercase box_s_none" data-filter="*">Tất cả</button></li>

                            <li class="m_right_5 m_bottom_10 m_xs_bottom_5 animate_ftr"><button class="button_type_2 bg_light_color_1 r_corners tr_delay_hover tt_uppercase box_s_none" data-filter="filter_class_new">Hot</button></li>

                            <li class="m_right_5 m_bottom_10 m_xs_bottom_5 animate_ftr"><button class="button_type_2 bg_light_color_1 r_corners tr_delay_hover tt_uppercase box_s_none" data-filter="filter_class_featured">Mới</button></li>

                            <li class="m_right_5 m_bottom_10 m_xs_bottom_5 animate_ftr"><button class="button_type_2 bg_light_color_1 r_corners tr_delay_hover tt_uppercase box_s_none" data-filter="filter_class_specials">Giảm giá</button></li>

                            {*                        <li class="m_right_5 m_bottom_10 m_xs_bottom_5 animate_ftr"><button class="button_type_2 bg_light_color_1 r_corners tr_delay_hover tt_uppercase box_s_none" data-filter="filter_class_specials">Bán chạy nhất</button></li>*}

                            <li class="m_right_5 m_bottom_10 m_xs_bottom_5 animate_ftr"><button class="button_type_2 bg_light_color_1 r_corners tr_delay_hover tt_uppercase box_s_none" data-filter="filter_class_hit">Yêu thích</button></li>

                            {*                        <li class="m_right_5 m_bottom_10 m_xs_bottom_5 animate_ftr"><button class="button_type_2 bg_light_color_1 r_corners tr_delay_hover tt_uppercase box_s_none" data-filter="filter_class_rated">Tất cả</button></li>*}
                    ...
                    <div class="wfilter_carousel m_bottom_30 m_xs_bottom_15">
                        ...
                        {foreach $data.list_hot as $item} 
                            <figure class="r_corners photoframe shadow relative tr_all_hover filter_class_new  animate_ftb long">
                                ...
                                <a href="#" class="d_block relative pp_wrap">
                                    ...
                                    <span class="hot_stripe"><img src="/common_pc/img/hot_product.png" alt=""></span>

                                    <img src="{$data.link_product}{$item.Product.id}/{$item.Product.id}_cover.jpg" class="tr_all_hover" alt="">

                                    <span data-popup="#quick_view_product" class="button_type_5 box_s_none color_light r_corners tr_all_hover d_xs_none">Xem nhanh</span>
                                ...
                                <figcaption>
                                    ...
                                    <h5 class="m_bottom_10"><a href="#" class="color_dark ellipsis">{$item.Product.name}</a></h5>

                                    <div class="clearfix">

                                        <p class="scheme_color f_left f_size_large m_bottom_15 price_vnd">{$item.Product.new_price_string}</p>
                                    ...
                                    <button class="button_type_4 bg_scheme_color r_corners tr_all_hover color_light mw_0">Mua hàng</button>
                        ...
                        {foreach $data.list_newest as $item} 
                            <figure class="r_corners photoframe shadow relative tr_all_hover filter_class_featured  animate_ftb long">
                                ...
                                <a href="#" class="d_block relative pp_wrap">
                                    ...
                                    <span class="hot_stripe"><img src="/common_pc/img/new_product_type.png" alt=""></span>
                        ...
                        {foreach $data.list_discount as $item} 
                            <figure class="r_corners photoframe shadow relative tr_all_hover filter_class_specials  animate_ftb long">
                                ...
                                <a href="#" class="d_block relative pp_wrap">
                                    ...
                                    <span class="hot_stripe"><img src="/common_pc/img/sale_product.png" alt=""></span>
                        ...
                        {foreach $data.list_most_love as $item} 
                            <figure class="r_corners photoframe shadow relative tr_all_hover filter_class_hit  animate_ftb long">
                                ...
                                <a href="#" class="d_block relative pp_wrap">
                                    ...
                                    <span class="hot_stripe"><img src="/common_pc/img/love_product_type.png" alt=""></span>
                        ...
                        <img src="/common_pc/img/product_img_2.jpg" class="tr_all_hover" alt="">

                        <span data-popup="#quick_view_product" class="box_s_none button_type_5 color_light r_corners tr_all_hover d_xs_none">Xem nhanh</span>
                        ...
                        <button class="button_type_4 bg_scheme_color r_corners tr_all_hover color_light f_left mw_0">Mua hàng</button>
                        ...
                        <img src="/common_pc/img/product_img_3.jpg" class="tr_all_hover" alt="">
                        ...
                        <img src="/common_pc/img/product_img_4.jpg" class="tr_all_hover" alt="">
                        ...
                        <span class="hot_stripe type_2"><img src="/common_pc/img/hot_product_type_2.png" alt=""></span>

                        <img src="/common_pc/img/product_img_5.jpg" class="tr_all_hover" alt="">
                        ...
                        <img src="/common_pc/img/product_img_6.jpg" class="tr_all_hover" alt="">
                        ...
                        <img src="/common_pc/img/product_img_7.jpg" class="tr_all_hover" alt="">
                        ...
                        <span class="hot_stripe type_2"><img src="/common_pc/img/sale_product_type_2.png" alt=""></span>

                        <img src="/common_pc/img/product_img_8.jpg" class="tr_all_hover" alt="">
                    ...
                    <div class="row clearfix m_bottom_45 m_md_bottom_35 m_xs_bottom_30">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 m_sm_bottom_35 blog_animate animate_ftr">
                            ...
                            <div class="clearfix m_bottom_25 m_sm_bottom_20">
                                ...
                                <h2 class="tt_uppercase color_dark f_left">Khuyến mãi</h2>
                            ...
                            <div class="blog_carousel">
                                ...
                                <div class="clearfix">
                                    ...
                                    <a href="#" class="d_block photoframe relative shadow wrapper r_corners f_left m_right_20 animate_ftt f_mxs_none m_mxs_bottom_10">
                                        ...
                                        <img class="tr_all_long_hover" src="/common_pc/img/blog_img_1.jpg" alt="">
                                ...
                                <div class="clearfix">
                                    ...
                                    <a href="#" class="d_block photoframe relative shadow wrapper r_corners f_left m_right_20 animate_ftt f_mxs_none m_mxs_bottom_10">
                                        ...
                                        <img class="tr_all_long_hover" src="/common_pc/img/blog_img_2.jpg" alt="">
                                ...
                                <div class="clearfix">
                                    ...
                                    <a href="#" class="d_block photoframe relative shadow wrapper r_corners f_left m_right_20 animate_ftt f_mxs_none m_mxs_bottom_10">
                                        ...
                                        <img class="tr_all_long_hover" src="/common_pc/img/blog_img_3.jpg" alt="">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 ti_animate animate_ftr">
                            ...
                            <div class="clearfix m_bottom_25 m_sm_bottom_20">
                                ...
                                <h2 class="tt_uppercase color_dark f_left f_mxs_none m_mxs_bottom_15">Phản hồi của khách hàng</h2>
                            ...
                            <div class="testiomials_carousel">
                                ...
                                <div>
                                    ...
                                    <img class="circle m_left_20 d_inline_middle animate_ftr" src="/common_pc/img/testimonial_img_1.jpg" alt="">
                                ...
                                <div>
                                    ...
                                    <img class="circle m_left_20 d_inline_middle" src="/common_pc/img/testimonial_img_2.jpg" alt="">
                                ...
                                <div>
                                    ...
                                    <img class="circle m_left_20 d_inline_middle" src="/common_pc/img/testimonial_img_3.jpg" alt="">
                    ...
                    <div class="clearfix">
                        ...
                        <h2 class="color_dark tt_uppercase f_left m_bottom_15 f_mxs_none heading5 animate_ftr">Sản phẩm bán chạy nhất</h2>
                    ...
                    <div class="bestsellers_carousel m_bottom_30 m_xs_bottom_15">
                        ...
                        {foreach $data.list_best_seller as $item}
                        ...
                        <figure class="r_corners photoframe shadow relative tr_all_hover animate_ftb long">
                            ...
                            <figcaption>
                                ...
                                <div class="clearfix m_bottom_15">
                                    ...
                                    <p class="scheme_color f_size_large f_left price_vnd">{$item.Product.new_price_string}</p>
                        ...
                        <img src="/common_pc/img/product_img_1.jpg" class="tr_all_hover" alt="">
                    ...
                    <section class="row clearfix m_bottom_45 m_sm_bottom_35">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 animate_half_tc">
                            ...
                            <a href="#" class="d_block banner wrapper r_corners relative m_xs_bottom_30">
                                ...
                                <img src="/common_pc/img/banner_img_1.png" alt="">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 animate_half_tc">
                            ...
                            <a href="#" class="d_block banner wrapper r_corners type_2 relative">
                                ...
                                <img src="/common_pc/img/banner_img_2.png" alt="">
                    ...
                    <div class="clearfix m_bottom_25 m_sm_bottom_20">
                        ...
                        <h2 class="tt_uppercase color_dark f_left heading2 animate_fade f_mxs_none m_mxs_bottom_15">Thương hiệu sản phẩm</h2>
                    ...
                    <div class="product_brands m_sm_bottom_35 m_xs_bottom_0">
                        ...
                        <a href="#" class="d_block t_align_c animate_fade"><img src="/common_pc/img/brand_logo.jpg" alt=""></a>
                ...
                <div class="footer_bottom_part">
                    ...
                    <div class="container clearfix t_mxs_align_c">
                        ...
                        <ul class="f_right horizontal_list clearfix f_mxs_none d_mxs_inline_b">
                            ...
                            <li><img src="/common_pc/img/payment_img_1.png" alt=""></li>

                            <li class="m_left_5"><img src="/common_pc/img/payment_img_2.png" alt=""></li>

                            <li class="m_left_5"><img src="/common_pc/img/payment_img_3.png" alt=""></li>

                            <li class="m_left_5"><img src="/common_pc/img/payment_img_4.png" alt=""></li>

                            <li class="m_left_5"><img src="/common_pc/img/payment_img_5.png" alt=""></li>
                    ...
                    <div class="custom_scrollbar">
                        ...
                        <div class="f_left half_column">
                            ...
                            <div class="relative d_inline_b m_bottom_10 qv_preview">
                                ...
                                <img src="/common_pc/img/quick_view_img_1.jpg" class="tr_all_hover" alt="">
                            ...
                            <div class="relative qv_carousel_wrap m_bottom_20">
                                ...
                                <ul class="qv_carousel d_inline_middle">
                                    ...
                                    <li data-src="/common_pc/img/quick_view_img_1.jpg"><img src="/common_pc/img/quick_view_img_4.jpg" alt=""></li>

                                    <li data-src="/common_pc/img/quick_view_img_2.jpg"><img src="/common_pc/img/quick_view_img_5.jpg" alt=""></li>

                                    <li data-src="/common_pc/img/quick_view_img_3.jpg"><img src="/common_pc/img/quick_view_img_6.jpg" alt=""></li>
                        ...
                        <div class="f_right half_column">
                            ...
                            <div class="clearfix m_bottom_15">
                                ...
                                <button class="button_type_12 r_corners bg_scheme_color color_light tr_delay_hover f_left f_size_large">Mua hàng</button>
        ...
        <div class="popup_wrap d_none" id="login_popup">
            ...
            <section class="popup r_corners shadow">
                ...
                <footer class="bg_light_color_1 t_mxs_align_c">
                    ...
                    <h3 class="color_dark d_inline_middle d_mxs_block m_mxs_bottom_15">Người dùng mới?</h3>

                    <a href="#" role="button" class="tr_all_hover r_corners button_type_4 bg_dark_color bg_cs_hover color_light d_inline_middle m_mxs_left_0">Tạo tài khoản</a>
